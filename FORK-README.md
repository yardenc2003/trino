...
2. Run the custom Docker build script, **optionally** providing the following arguments:
   - The base Trino version (default: `483`)
   - A custom fork version (default: `483.0`)
   - The target architecture (e.g., `amd64`, `arm64`, `ppc64le`)
      ...
      Or:
       ...
       ```bash
       ./core/docker/forked-trino-docker.sh 483 483.<tag> <arch>
       ```
...
- `trino-history-webui:483.<tag>-amd64`
- `trino-history-webui:483.<tag>-arm64`
- `trino-history-webui:483.<tag>-ppc64le`
